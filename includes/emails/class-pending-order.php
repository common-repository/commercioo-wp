...
/**
 * Pending Order email.
 * This email will be sent for customer for pending order.
 *
...
if ( ! class_exists( 'Commercioo\Emails\Pending_Order' ) ) {
	 ...
	 */
	class Pending_Order extends Order_Mailer {

		/**
		 * Pending_Order constructor.
		 *
		...
		public function __construct( $order_id ) {
			...
			$subject = isset( $emails['mail_pending_order']['subject'] ) ? $emails['mail_pending_order']['subject'] : null;
			$content = isset( $emails['mail_pending_order']['content'] ) ? $emails['mail_pending_order']['content'] : null;
