 ...
 *     ?>
 */
function comm_bootstrap_pagination( \WP_Query $wp_query = null, $echo = true, $params = []) {
    if ( null === $wp_query ) {
        global $wp_query;
    }
    ...
    /*if (isset($_GET[ 'sort' ])) {
        $add_args[ 'sort' ] = sanitize_key((string)$_GET[ 'sort' ]);
    }*/
    ...
    if ( is_array( $pages ) ) {
        ...
        $pagination = '<div class="float-right pagination"><ul class="pagination">';
