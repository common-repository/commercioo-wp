...
<div class="col-md-1 mb-2 view-first-col">
...
<div class="col-md-4 mb-2 view-second-col">
...
<!-- Right Product -->
<div class="col-md-6 mb-2 custom-scroll-category view-third-col">
    ...
    <div class="product-actions-wrapper">
        <div class="row">
            <div class="col-sm-4 col-md-4 mt-2" style="padding-right: 0;">
            ...
            <div class="col-sm-7 col-md-7 mt-2">
    			<a href="#" class="btn btn-add-to-cart comm-add-to-cart <?php echo esc_attr($get_stock_status == 'outofstock' ? 'disabled' :'');?>" data-id="<?php echo esc_attr($product_id); ?>">
    				<?php echo esc_html( \Commercioo\Helper::button_label( 'add_to_cart' ) ) ?>
    			</a>
            </div>
            <div class="col-sm-1 col-md-1 mt-2 d-none">
                <span class="btn btn-favorite-product wishlist-product" data-bs-container="body" data-bs-toggle="popover-product" data-bs-trigger="hover" data-bs-placement="top" data-bs-content="Add to Wishlist." >
